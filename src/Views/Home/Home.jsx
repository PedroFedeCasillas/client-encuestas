    ...
    return (
        <div className={styles.home}>
            <div className={styles.data}>
                    <h3 style={{fontSize:"5.5vh", paddingLeft:"3vw",paddingRight:"3vw", marginTop:"7vh" }}>BIENVENIDO A TU CUENTA DE ENCUESTAS</h3>
                <div className={styles.userData}>
                    <h1 style={{fontSize:"2.5vh",textTransform:"uppercase", textDecoration: "underline rgb(100, 103, 100)"  }}>Datos de cuenta</h1>
                ...
                <p style={{ color: "#e5e5e5", fontSize: "1.7vh", paddingLeft:"5vw",paddingRight:"5vw" }}>*Recuerda que no podras agregar a tu cuenta un formulario que ya completaste!</p>
            </div>
